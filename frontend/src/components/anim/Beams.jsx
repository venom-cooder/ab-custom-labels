...
const CanvasWrapper = ({ children }) => (
  <Canvas dpr={[1, 2]} frameloop="always" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', zIndex: 0, pointerEvents: 'none' }}>
    {children}
  </Canvas>
);
...
const Beams = ({
  ...
  beamHeight = 18,
  beamNumber = 8,
  lightColor = '#000000', // Changed to Black for contrast on White BG
  speed = 2,
  noiseIntensity = 1.2,
  scale = 0.3,
  rotation = 0
  ...
  const beamMaterial = useMemo(
    () =>
      extendMaterial(THREE.MeshStandardMaterial, {
        ...
        material: { fog: true },
        uniforms: {
          diffuse: new THREE.Color(...hexToNormalizedRGB('#f0f0f0')), // Light Grey Beams
